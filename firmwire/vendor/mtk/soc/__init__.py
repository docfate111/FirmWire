...
class MT6768(MediaTekSOC):
    ...
    SHM_QUEUE_NUM = 16
    SHM_LAYOUT = {
        "rx_sizes": [80, 80, 40, 80, 20, 20, 64, 1, 8, 1, 1, 1, 1, 1, 1, 1],
        "tx_sizes": [128, 40, 8, 40, 20, 20, 64, 1, 8, 1, 1, 1, 1, 1, 1, 1],
        "rx_sizes_exp": [12, 32, 8, 1, 1, 1, 8, 1, 1, 1, 1, 1, 1, 1, 1, 1],
        "tx_sizes_exp": [12, 32, 8, 1, 1, 1, 8, 1, 1, 1, 1, 1, 1, 1, 1, 1],
    }
...
class MT6765(MediaTekSOC):
    ...
    SHM_QUEUE_NUM = 17
    SHM_LAYOUT = {
        "rx_sizes": [80, 80, 40, 80, 20, 20, 64, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8],
        "tx_sizes": [128, 40, 8, 40, 20, 20, 64, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8],
        "rx_sizes_exp": [12, 32, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8],
        "tx_sizes_exp": [12, 32, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8],
    }
